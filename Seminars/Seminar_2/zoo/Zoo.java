...
public class Zoo {
    ...
    public List<String> getSwimList() {
        List<String> names = new ArrayList<>();
        for (Animal animal : this.animalList) {
            if (animal instanceof swimingInterface) {
    ...
    public Animal getRunChampion(){
        System.out.printf("____Определяем чемпиона по бегу_____  ---> ");
    ...
    public Animal getFlightChampion(){
        System.out.printf("____Определяем чемпиона по полётам_______ ---> ");
